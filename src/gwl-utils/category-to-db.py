...
def upsert_categories(categories: List[Tuple[str, str, datetime.date]], table_name: str):
    """
    ...
    try:
        with open(file_path, mode="r", encoding="utf-8") as csvfile:
            ...
            for row in reader:
                ...
                category_id = normalize_category_id(row.get("CLASS", "")) or "000"
                category_text = normalize_text(row.get("KSCHG", "")) or "000"
                    ...
                    with open(file_path, "r", encoding="utf-8") as infile:
                        ...
                        for line in infile:
                            try:
                                ...
                                normalized_category_id = normalize_category_id(raw_category_id)
